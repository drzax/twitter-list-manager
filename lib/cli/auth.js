// Exports
module.exports.command = 'auth';
module.exports.describe = 'Authorise with Twitter';
...
function auth(callback) {
	...
	oa = new OAuth.OAuth(REQUEST_TOKEN_URL, ACCESS_TOKEN_URL, cfg.oauth_consumer_key, cfg.oauth_consumer_secret, OAUTH_VERSION , 'oob', HASH_VERSION);
